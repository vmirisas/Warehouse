...
CREATE TABLE `stock` (
  ...
  `form_detail_id` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FK_PRODUCT` (`barcode`),
  KEY `FK_SHELF` (`shelf_code`),
  KEY `FK_FORM_DETAIL_idx` (`form_detail_id`),
  CONSTRAINT `FK_FORM_DETAIL` FOREIGN KEY (`form_detail_id`) REFERENCES `form_detail` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- Dump completed on 2022-10-26 15:05:29
